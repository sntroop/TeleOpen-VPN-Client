  ...
  Future<void> _load() async {
    ...
    try {
      ...
      setState(() {
        _items = res.items
          ..sort((a, b) {
            final aBadge = a.teleOpenBadge != null ? 0 : 1;
            final bBadge = b.teleOpenBadge != null ? 0 : 1;
            return aBadge.compareTo(bBadge);
          });
        _total = res.total;
        _loading = false;
      });
            ...
            child: Row(children: [
                ...
                GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: Row(children: [
                        Icon(CupertinoIcons.shield_fill, size: 14, color: c.textPrimary),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    Icon(
                      state.currentUser == null ? CupertinoIcons.paperplane : CupertinoIcons.person_fill,
          ...
          if (_selectedTags.isNotEmpty)
            Padding(
              ...
              child: Row(children: [
                ...
                GestureDetector(
                  behavior: HitTestBehavior.opaque,
                  onTap: () { setState(() => _selectedTags.clear()); _load(); },
                  child: Text('Сбросить', style: t.textStyles.footnote.copyWith(color: c.red)),
                ),
              ]),
            ),
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              Expanded(
                child: Text(item.name, style: t.textStyles.headline, maxLines: 1, overflow: TextOverflow.ellipsis),
              ),
              const SizedBox(width: 6),
              if (item.ratingCount > 0) ...[
                ...
                Text(item.ratingAvg.toStringAsFixed(1),
                  style: t.textStyles.footnote.copyWith(fontWeight: FontWeight.w600)),
              ] else
                Text('- ', style: t.textStyles.footnote.copyWith(color: c.textTertiary)),
            ]),
            ...
            Row(children: [
              _Stat(icon: CupertinoIcons.cloud_fill, value: '${item.nodesCount}'),
              const SizedBox(width: 12),
              _Stat(
              ...
              const SizedBox(width: 12),
              _Stat(icon: CupertinoIcons.arrow_down_circle, value: _kFormat(item.getsCount)),
              const Spacer(),
...
class _TeleOpenBadgeChip extends StatelessWidget {
  ...
  Color _bgColor(TeleOpenBadge b, IosColors c) {
    switch (b) {
      case TeleOpenBadge.official:  return const Color(0xFF007AFF).withValues(alpha: 0.13);
      case TeleOpenBadge.verified:  return const Color(0xFF34C759).withValues(alpha: 0.13);
      case TeleOpenBadge.partner:   return const Color(0xFFFF9F0A).withValues(alpha: 0.13);
    }
  }
...
class _CardIcon extends StatelessWidget {
  ...
  Widget _fallback(IosColors c, String name, IosThemeData t) {
    final initial = name.isEmpty ? '?'.codeUnitAt(0) : name.runes.first as int;
    return Container(
      width: 52, height: 52,
      decoration: BoxDecoration(
        color: c.fill,
...
class _Stat extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(children: [
      ...
      const SizedBox(width: 4),
      Text(value, style: t.textStyles.caption1.copyWith(color: color ?? c.textSecondary)),
    ]);
  }
}
      ...
      children: [
        ...
        Center(
          child: Column(children: [
            ...
            Text('Ничего не найдено', style: t.textStyles.body.copyWith(color: c.textSecondary)),
