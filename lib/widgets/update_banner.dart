            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  // Запасной путь: если докачка в приложении почему-то не идёт,
                  // юзер всегда может взять APK напрямую с сайта.
                  GestureDetector(
                    behavior: HitTestBehavior.opaque,
                    onTap: () => launchUrl(
                      Uri.parse('https://teleopen.space'),
                      mode: LaunchMode.externalApplication,
                    ),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(Icons.public, size: 16, color: c.blue),
                        const SizedBox(width: 6),
                        Flexible(
                          child: Text(
                            'Не качается? Скачать с сайта teleopen.space',
