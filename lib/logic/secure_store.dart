...
class SecureStore {
  ...
  // Удаление legacy-блоба после миграции в NodeStore (файловое хранилище).
  static Future<void> deleteGroups() => _storage.delete(key: _kGroups);

  // Ключ шифрования файлового хранилища нод (NodeStore). Сам блоб нод слишком
  // велик для secure_storage, а вот 32-байтный ключ — в самый раз.
  static const _kNodesKey = 'nodes_key';
  static Future<String?> readNodesKey() => _storage.read(key: _kNodesKey);
  static Future<void> writeNodesKey(String value) =>
      _storage.write(key: _kNodesKey, value: value);
