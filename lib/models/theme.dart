...
//
// Пользовательская тема: цвета + радиусы + фон + метаданные.
// JSON-формат симметричен серверной таблице `themes`.

import 'package:flutter/material.dart';
import '../ios_theme.dart';

class UserTheme {
  final int? id;             // null = локальная неопубликованная
  final String name;
  ...
  /// Превратить в IosThemeData для применения.
  ...
  /// Дефолтная "новая тема" — копия системной dark с именем.
