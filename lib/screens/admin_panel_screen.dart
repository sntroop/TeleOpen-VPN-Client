...
import 'admin/announcement_list_screen.dart';
import 'admin/seller_admin_screen.dart';
            ...
            child: Row(children: [
              ...
              GestureDetector(
                ...
                onTap: () => Navigator.of(context).push(
                  CupertinoPageRoute(builder: (_) => const SellerAdminScreen()),
                ),
                child: Padding(
                  padding: const EdgeInsets.all(8),
                  child: Icon(CupertinoIcons.creditcard_fill, size: 20, color: c.textPrimary),
                ),
              ),
              GestureDetector(
                behavior: HitTestBehavior.opaque,
                onTap: () => Navigator.of(context).push(
                  CupertinoPageRoute(builder: (_) => const AnnouncementListScreen()),
                ),
                child: Padding(
                  padding: const EdgeInsets.all(8),
                  child: Icon(CupertinoIcons.bell_fill, size: 20, color: c.textPrimary),
                ),
              ),
              GestureDetector(
                behavior: HitTestBehavior.opaque,
