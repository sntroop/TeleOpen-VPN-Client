...
//
// Экран настроек WARP (Cloudflare WARP / WireGuard-обёртка с шумом):
//   - Включить WARP
...
//   - Чистый IP
//   - Порт
//   - Параметры шума (количество, режим, размер, задержка)
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            const SliverToBoxAdapter(child: _ScreenHeader(title: 'WARP')),
        ...
        actions: [
          IosButton(
            ...
            onPressed: () {
              ...
              // TODO: реальная генерация через нативный бридж
            },
          ),
          IosButton(
            label: 'Отмена',
