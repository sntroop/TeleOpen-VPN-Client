// lib/screens/tls_tricks_screen.dart
//
// Экран "Трюки TLS" — приёмы против DPI:
//   - Фрагментация TLS-handshake
//   - Смешанный регистр SNI
//   - Дополнение (padding) ClientHello
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            const SliverToBoxAdapter(child: _ScreenHeader(title: 'Трюки TLS')),
