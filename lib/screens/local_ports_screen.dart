// lib/screens/local_ports_screen.dart
//
// Экран "Локальные порты" (Переопределение → Основные):
//   - HTTP / Socks / Redir / TProxy / Mixed порты
//   - Аутентификация (логин/пароль для HTTP/Socks)
//   - Allow LAN
//   - IPv6 (на этом блоке только локальная привязка — toggle)
//   - Bind address
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            const SliverToBoxAdapter(child: _ScreenHeader(title: 'Локальные порты')),
