...
//
// Галерея опубликованных тем: список с превью, сортировка, тап → детали.
...
class _ThemeGalleryScreenState extends State<ThemeGalleryScreen> {
  ...
  bool _loading = true;
  String? _error;
  String _sort = 'popular'; // 'popular' | 'new'
  String? _mode; // 'light' | 'dark' | null
...
class _ThemeListCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // 5 ключевых цветов для превью-полоски
    final palette = [
    ...
    return IosCard(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        // Mini-preview: имитация экрана на цветах темы
        Container(
          height: 64,
