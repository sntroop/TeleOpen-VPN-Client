...
//
// Экран "Сеть" — настройки интеграции с VpnService:
//   - Маршрутизировать системный трафик
//   - Игнорировать частные сети
//   - Перехват DNS
//   - Разрешить обход VPN приложениями
//   - Allow IPv6
//   - Системный HTTP-прокси помимо VPN
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            const SliverToBoxAdapter(child: _ScreenHeader(title: 'Сеть')),
